            ...
            <div className="w-full flex flex-col items-center md:items-start pt-12 md:pl-[45%] lg:pl-24 md:pt-0">
              ...
              <AnimatePresence mode="wait">
                {!isFlipped ? (
                  ...
                  >
                    {/* Nutrition Badges */}
                    <div className="grid grid-cols-2 lg:flex lg:flex-nowrap items-start lg:items-center justify-items-center lg:justify-start w-full md:w-full lg:w-full md:pl-8 lg:pl-0 max-w-2xl mb-8 md:mb-12 mt-2 md:mt-4 gap-y-6 sm:gap-y-8 gap-x-2 sm:gap-x-4 lg:gap-8">
