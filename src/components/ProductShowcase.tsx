            ...
            <div className="w-full flex flex-col items-center md:items-start pt-12 md:pl-[40%] lg:pl-24 md:pt-0">
              ...
              <AnimatePresence mode="wait">
                {!isFlipped ? (
                  ...
                  >
                    {/* Nutrition Badges */}
                    <div className="grid grid-cols-2 lg:flex lg:flex-nowrap items-start lg:items-center justify-items-center lg:justify-start w-full md:w-[75%] lg:w-full md:self-center lg:self-start max-w-2xl mb-8 md:mb-12 mt-2 md:mt-4 gap-y-6 sm:gap-y-8 gap-x-2 sm:gap-x-4 lg:gap-8">
                      <div className="text-center w-full lg:w-auto">
                        <span className="font-bolero text-5xl sm:text-5xl md:text-5xl lg:text-6xl text-white leading-none">4g</span><br/>
                        <span className="text-white/90 text-xs sm:text-xs md:text-xs lg:text-sm font-bold tracking-widest mt-1 md:mt-2 block leading-tight uppercase">SUGAR</span>
                      </div>
                      <div className="hidden lg:block w-px h-12 lg:h-20 bg-white/30" />
                      <div className="text-center w-full lg:w-auto">
                        <span className="font-bolero text-5xl sm:text-5xl md:text-5xl lg:text-6xl text-white leading-none">100%</span><br/>
                        <span className="text-white/90 text-xs sm:text-xs md:text-xs lg:text-sm font-bold tracking-widest mt-1 md:mt-2 block leading-tight uppercase">PLANT<br/>BASED</span>
                      </div>
                      <div className="hidden lg:block w-px h-12 lg:h-20 bg-white/30" />
                      <div className="text-center w-full lg:w-auto">
                        <span className="font-bolero text-5xl sm:text-5xl md:text-5xl lg:text-6xl text-white leading-none">10g</span><br/>
                        <span className="text-white/90 text-xs sm:text-xs md:text-xs lg:text-sm font-bold tracking-widest mt-1 md:mt-2 block leading-tight uppercase">PREBIOTIC<br/>FIBER</span>
                      </div>
                      <div className="hidden lg:block w-px h-12 lg:h-20 bg-white/30" />
                      <div className="text-center w-full lg:w-auto">
                        <span className="font-bolero text-5xl sm:text-5xl md:text-5xl lg:text-6xl text-white leading-none">ZERO</span><br/>
                        <span className="text-white/90 text-xs sm:text-xs md:text-xs lg:text-sm font-bold tracking-widest mt-1 md:mt-2 block leading-tight uppercase">SUGAR<br/>ALCOHOLS</span>
                      </div>
                    </div>
                  </motion.div>
                )}
