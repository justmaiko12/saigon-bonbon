      ...
      <AnimatePresence>
        {isScrolled && (
          <motion.div
            ...
            className="fixed top-6 left-1/2 -translate-x-1/2 z-50 w-[90%] max-w-4xl bg-black/60 backdrop-blur-xl rounded-full px-6 py-3 flex items-center justify-between shadow-2xl border border-white/20"
          >
            {/* Logo on the left */}
